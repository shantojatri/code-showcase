<x-layout>
    <div class="w-full max-w-2xl mx-auto">
        <div class="flex h-full items-center py-5">
                        ...
                        <div class="mt-5">
                            ...
                            <form accept="{{ route('user.register') }}" method="POST">
                                ...
                                <div class="grid gap-y-4">
                                    ...
                                    <!-- Form Group -->
                                    <div>
                                        <label for="mobile" class="block text-sm mb-2">Mobile Number</label>
                                        <div class="relative">
                                    ...
                                    <div>
                                        <div class="flex justify-between items-center">
                                            <label for="password_confirmation" class="block text-sm mb-2">Confirm
                                                Password</label>
                                        </div>
                                        <div class="relative">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ms-3">
                                            <label for="remember-me" class="text-sm">Accept terms & conditions</label>
                                        </div>
                                    </div>
                                    <!-- End Checkbox -->
